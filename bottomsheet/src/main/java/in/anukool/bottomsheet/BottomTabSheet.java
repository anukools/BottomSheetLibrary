package in.anukool.bottomsheet;
...
public class BottomTabSheet extends RelativeLayout {
    ...
    public BottomTabSheet(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public static void bindItems(BottomTabSheet BottomTabSheet, @MenuRes int res) {
        BottomTabSheet.setItems(res);
    }

    @BindingAdapter("app:listener")
    public static void bindListener(BottomTabSheet BottomTabSheet, OnItemSelectedListener listener) {
        BottomTabSheet.setListener(listener);
    }

    @BindingAdapter("app:selectedTab")
    public static void bindSelectedTab(BottomTabSheet BottomTabSheet, int id) {
        BottomTabSheet.setSelectedTab(id);
    }

    @BindingAdapter("app:buttonTextStyle")
    public static void bindButtonTextStyle(BottomTabSheet BottomTabSheet, @StyleRes int res) {
        BottomTabSheet.setButtonTextStyle(res);
    }

    @BindingAdapter("app:indicatorVisible")
    public static void bindIndicatorVisibke(BottomTabSheet BottomTabSheet, boolean isVisible) {
        BottomTabSheet.setIndicatorVisible(isVisible);
    }

    @BindingAdapter("app:indicatorHeight")
    public static void bindIndicatorHeight(BottomTabSheet BottomTabSheet, float height) {
        BottomTabSheet.setIndicatorHeight(height);
    }

    @BindingAdapter("app:indicatorColor")
    public static void bindIndicatorColor(BottomTabSheet BottomTabSheet, @ColorRes int color) {
        BottomTabSheet.setIndicatorColor(color);
    }

    @BindingAdapter("app:indicatorLineColor")
    public static void bindIndicatorLineColor(BottomTabSheet BottomTabSheet, @ColorRes int color) {
        BottomTabSheet.setIndicatorLineColor(color);
    }
    /*
        ---------------------------------
     */
